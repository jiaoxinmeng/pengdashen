	...
	<body class="home">
		...
		<%@include file="head.jsp" %>
				...
				<div class="fullwidthbanner">
					<ul>
						...
						<li data-transition="slidedown" data-slotamount="15"
							...
							<img src="images/slides/1_ydjd_0011.jpg" alt="" />
						...
						<li data-transition="fade" data-slotamount="15"
							...
							<img src="images/slides/1_ydjd_0010.jpg" alt="" />
							...
							<div class="caption box-slide2 lft ltt" data-x="770" data-y="110"
								...
								<p>
								油菜组“十一五”期间育成浙油18、浙油50等新品种8个，其中5个通过国家品种审定。品种2013在浙江省推广面积达200万亩，占70%。
								</p>
							</div>
						</li>
						...
						<li data-transition="papercut" data-slotamount="15"
							data-masterspeed="300">
							<img src="images/slides/1_ydjd_0030.jpg" alt="" />

							<!-- THE FIFTH SLIDE -->
							<li data-transition="slideright" data-slotamount="15"
								data-masterspeed="300">
								<img src="images/slides/1_ydjd_0004.jpg" alt="" />
								...
								<div class="caption description_text lfl stl" data-x="0"
									...
									温室配有自然通风系统、遮阳保温系统、湿帘风机降温系统、自动供水系统等先进设备。
								</div>
							</li>
							<!-- THE SIX SLIDE -->
							<li data-transition="slideright" data-slotamount="15"
								data-masterspeed="300">
								<img src="images/slides/1_ydjd_0003.jpg" alt="" />
							...
							<li data-transition="slideright" data-slotamount="15"
								data-masterspeed="300">
								<img src="images/slides/lcslide01.jpg" alt="" />
			...
			<div class="centered-wrapper">
				...
				<section class="intro">
				<h2>
					创建一流现代院所、创新一流科研成果、创造一流服务业绩
				</h2>
				<h5>
					将园区建成我省农业科研创新中心、现代农业种业基地、绿色农业生产示范基地、现代农业科技和文化交流平台
				</h5>
				</section>
				...
				<ul id="portfolio-carousel">
					<s:iterator value="baseList">
						...
						<div class="portfolio-carousel-details">
							...
							<a href="http://ditu.amap.com/search?query=<s:property value="baseLocationDetail"/> " target="_blank" title="<s:property value="baseLocationDetail"/>" class="baseLocationDetail"><i class="icon-map-marker"></i><span><s:property value="baseLocation"/></span></a>
						</div>
					</li>
					</s:iterator>
				...
				<div class="one-third column-last">
					...
					<ul class="customlist tick-list">
						<s:iterator value="leaderList">
							<li>
								<a href="news!detail.do?id=<s:property value="id"/>&newsType=<s:property value="newsType"/>" target="_blank">
									
									<s:if test="newsTitle.length()>18">
			...
			<div class="one-third">
				...
				<div align="right"><a href="team!list.do">更多&nbsp;<i class="icon-double-angle-right"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;</div>
				<ul class="clients">
					<s:iterator value="teamList">
							<li><a class="groups"  href="team!detail.do?id=<s:property value="id"/>"><img src="images/groups/<s:property value="teamLogo"/>"
								alt="client" /></a></li>
					</s:iterator>
				</ul>
				</section>
