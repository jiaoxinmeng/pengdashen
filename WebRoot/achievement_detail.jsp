		...
		<div id="wrapper">
			...
			<div class="title-wrapper">
				<div class="title-bg">
					<div class="title-content">
						<div class="title">
								<s:property value="achievement.achievementTitle"/>
						</div>
						<div class="clear"></div>
					</div>
					<!--end title-content-->
			...
			<div class="centered-wrapper">
				...
				<div class="testimonial-author">
					<i class="icon-user"></i>&nbsp; <s:property value="achievement.achievementAuthor"/>&nbsp;&nbsp;&nbsp;<i class="icon-time"></i>&nbsp;<s:date name="achievement.achievementDate"  format="yyyy-MM-dd"/>
				</div>
				<div class="testimonial">
					<p>
						<s:property value="achievement.achievementContent" escape="false"/>
					</p>
				</div>
			...
			<div class="aligncenter">
				<a class="button yellow" href="achievement.do?achievementType=<s:property value="achievement.achievementType"/>">返回列表</a>
			</div>
