...
<body>
	<div id="main_content_wrap" class="container_12">
    	<div class="container_12">
    		<h2>base_img</h2>
			<form action="base!doImgEdit.do" method="post" enctype="multipart/form-data">
				<input type="hidden" name="baseImg.id" value="<s:property value="baseImg.id"/>"/>
				<p>
					<label>作者：</label>
				...
				<p>
					...
					<select id="imgBaseId" name="baseImg.imgBaseId">
						<option value="<s:property value="baseImg.imgBaseId"/>"><s:property value="baseImg.imgBase"/></option>
						<s:iterator value="baseList">
							<option value="<s:property value="id"/>" <s:if test="baseImg.imgBaseId==id">selected="selected"</s:if>><s:property value="baseTitle"/></option>
						</s:iterator>
					</select>
				</p>
				<p>
