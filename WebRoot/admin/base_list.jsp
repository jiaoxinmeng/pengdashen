    		...
    		<div id="icondock" class="grid_12">
    		  <ul>
    		    <s:iterator value="baseList">
    		      <li><a href="base!doView.do?id=<s:property value="id"/>" target="middleFrame" title="查看<s:property value="baseTitle"/>详情"><img width="190" src="../images/background/<s:property value="baseImg"/>" alt="Contacts" /><s:property value="baseTitle"/></a></li>
    		    </s:iterator>  
    		  </ul>
    		</div>
    	</div>
