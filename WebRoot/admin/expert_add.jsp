...
<body>
	<div id="main_content_wrap" class="container_12">
    	<div class="container_12">
    		...
    		<div>
    			<form action="expert!doAdd.do" method="post" enctype="multipart/form-data">
    				<p><label>姓名：</label><input type="text" class="text small" name="expert.expertName" /></p>
	    			<p><label>type：</label><input type="text" class="text small" name="expert.expertType" /></p>
	    			<p><label>order：</label><input type="text" class="text small" name="expert.expertOrder"/></p>
	    			<p>
	    				<label>图片：</label>
	    			...
	    			<p><label>简介：</label><input type="text" class="text large" name="expert.expertSummary" /></p>
	    			<p><label>正文：</label><textarea name="expert.expertContent"></textarea></p>
	    			<p>
