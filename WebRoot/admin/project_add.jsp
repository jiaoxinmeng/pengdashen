...
<body>
	<div id="main_content_wrap" class="container_12">
    	<div class="container_12">
	    	<form action="project!doAdd.do" method="post" enctype="multipart/form-data">
	    		<p><label>项目名称：</label><input type="text" class="text small" name="project.projectTitle"/></p>
	    		<p>
	    			<label>所属团队：</label>
	    		...
	    		<p><label>项目基金：</label><input type="text" class="text small" name="project.projectFund"/></p>
	    		<p><label>项目类型：</label><input type="text" class="text small" name="project.projectType"/></p>
	    		<p><label>发起日期：</label><input type="text" class="text small" name="project.projectDate"/></p>
	    		<p><label>项目介绍：</label><textarea name="project.projectContent"></textarea></p>
	    		<p>
