...
<body>
	<div id="main_content_wrap" class="container_12">
    	<div class="container_12">
    		...
    		<div>
    			<form action="team!doEdit.do" method="post" enctype="multipart/form-data">
    				
    				<input type="hidden" name="team.id" value="<s:property value="team.id"/>"/>
    				
    				<p><label>名称:</label><input type="text" class="text small" name="team.teamTitle" value="<s:property value="team.teamTitle"/>"/></p>
    				...
    				<p>
						...
						<input type="hidden" name="team.teamImg" value="<s:property value="team.teamImg"/>"/>
					</p>
