			...
			<div class="title-wrapper">
				<div class="title-bg">
					<div class="title-content">
						<div class="title">
							功能区块 &nbsp;&nbsp;
							<font color="#F8A436">Function Area&nbsp;&nbsp;<i
				...
				<div id="masonry-blog" class="columns-three infinite-scrolling">
					...
					<div class="masonry-post regular-article">
						<div class="masonry-thumbnail">
							<a href="#">
								...
								<img src="images/area/<s:property value="businessImg" />" alt="" />
							</a>
						</div>
						<div class="masonry-page-content">
							...
							<h1 class="masonry-title"><a href="business!detail.do?id=<s:property value="id"/>"><s:property value="businessTitle" /></a></h1>
							<p class="masonry-excerpt"><s:property value="businessSummary" escape="false"/></p>
							<a class="button red" href="business!detail.do?id=<s:property value="id"/>">Read More</a>
						</div>
					</div>
					</s:iterator>	
					...
					<div align="center">
						<s:if test="pageCount!=null">
							...
							<s:else>
								<a href="business!list.do?page=${page-1}"
