		...
		<div id="wrapper">
			...
			<div class="title-wrapper">
				<div class="title-bg">
					<div class="title-content">
						<div class="title">
								基地专家&nbsp; <i class="icon-user"></i>&nbsp; --------&nbsp; <s:property value="expert.expertName"/>
						</div>
						<div class="clear"></div>
					</div>
					<!--end title-content-->
			...
			<div class="centered-wrapper">
				...
				<div class="testimonial">
					<p><center><img src="images/experts/<s:property value="expert.expertImg"/>" border="0"/><br/><span><s:property value="expert.expertName"/></span></center><br/>
						<s:property value="expert.expertContent" escape="false"/>
					</p>
				</div>
