		...
		<div id="wrapper">
			...
			<div class="centered-wrapper">
				...
				<div class="testimonial-author">
					<i class="icon-user"></i>&nbsp; <s:property value="news.newsAuthor"/>&nbsp;&nbsp;&nbsp;<i class="icon-time"></i>&nbsp;<s:date name="news.newsDate"  format="yyyy-MM-dd"/>
				</div>
			...
			<div class="aligncenter">
				<a class="button yellow" href="news.do?newsType=<s:property value="news.newsType"/>">返回列表</a>
			</div>
