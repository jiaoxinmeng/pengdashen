...
$(function() {
	...
	<body>
		<div id="wrapper">
			...
			<div class="title-wrapper">
				<div class="title-bg">
					<div class="title-content">
						<div class="title">
							<s:property value="team.teamTitle" />
						</div>
						<div class="clear"></div>
					</div>
					<!--end title-content-->
			...
			<div class="centered-wrapper" style="width: 800px;">

				<div id="slides" style="width: 800px;">
					<div class="slides_container" style="width: 800px;">
						<s:iterator value="teamImgList">
							<div class="slide">
								<a href="images/teams/<s:property value="imgName"/>"
									rel="prettyPhoto[pp_gal]"
									title="<s:property value="imgContent"/>  <s:property value="imgAuthor"/>"><img
										src="images/teams/<s:property value="imgName"/>" alt=" ">
								</a>
							</div>
						</s:iterator>
					</div>
					<a href="#" class="prev"><img src="images/blog-arrow-prev.png"
							width="27" height="43" alt="Arrow Prev">
					</a>
					<a href="#" class="next"><img src="images/blog-arrow-next.png"
							width="27" height="43" alt="Arrow Next">
					</a>
				</div>
			</div>
			...
			<div class="centered-wrapper">
				...
				<s:set name="achievementListSize" value="achievementList.size()" />
				<s:if test="#achievementListSize>0">
				<div class="testimonial">
					<p>
						科研成果
					</p>
					<p>
						<s:iterator value="achievementList" status="st">
							<s:property value="#st.index+1" />.&nbsp<a
								href="achievement!detail.do?id=<s:property value="id"/>"><s:property
			...
			<div class="aligncenter">
				<a class="button yellow" href="team!list.do">返回列表</a>
			</div>
