			...
			<div class="centered-wrapper">
				...
				<ul class="portfolio four-columns">
					<s:iterator value="teamList">
						...
						<a href="images/teams/<s:property value="teamImg"/>"
							title=""> <span class="item-on-hover"><span
								class="hover-image"></span>
						</span> <img src="images/teams/<s:property value="teamImg"/>" alt=" " /> </a>
						<div class="portfolio-carousel-details">
							<h3>
								<a href="team!detail.do?id=<s:property value="id"/>"><s:property value="teamTitle"/></a>
							</h3>
